AFRAME.registerComponent('axis-powers', {
  ...
  init: function() {
    ...
    this.el.addEventListener('touchstart', this.triggerDown.bind(this));
  },

  triggerDown: function() {
    AFRAME.log("X Axis: " + window.navigator.getGamepads()[1].axes[0]);
    AFRAME.log("Y Axis: " + window.navigator.getGamepads()[1].axes[1]);
  },
